...
<body class="body_bg">
	<div class="whole">
		...
		<form id="form1" action="http://localhost:8080/maven02/login/update" method="get" class="form_box">
			...
			<div class="finish_box">
				<input class="finish_btn" type="submit" id="finish" name="finish" value="Finish" onclick="select()"/>
			</div>
		</form>
	</div>
</body>
